...
@section('content')
    <div class="pagetitle">
        <h1>Created ChilPart KBI</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                <li class="breadcrumb-item"><a href="{{ route('cipat.index') }}">ChilPart</a></li>
                <li class="breadcrumb-item active">Created ChilPart</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
