...
class CipatImport implements ToModel, WithHeadingRow, WithStartRow
{
    public $errorRows = [];
    ...
    public function model(array $row)
    {
        ...
        $existingCipat = Cipat::where('inventory_id', $row['inventory_id'])
        ...
        try {
            if ($existingCipat) {
                ...
                $this->successfulRows[] = $existingCipat;
            } else {
                ...
                $this->successfulRows[] = $cipat;
            }

            DB::commit(); // Commit jika berhasil
            return $existingCipat ?? $cipat;
        } catch (\Exception $e) {
